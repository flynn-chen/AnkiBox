  ...
  while cap.isOpened():
    ...
    if results.pose_landmarks:
      ...
      left_arm_length = findDistance(
          ...
          results.pose_landmarks.landmark[lmPose.LEFT_WRIST].x,
          results.pose_landmarks.landmark[lmPose.LEFT_WRIST].y)
      
      right_arm_length = findDistance(
          results.pose_landmarks.landmark[lmPose.RIGHT_SHOULDER].x,
